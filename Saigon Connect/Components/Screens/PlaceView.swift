...
struct PlaceView: View {
    ...
    // toggle event view
    @State var isEventView = false
    
    // toggle place view
    @State var isPlaceView = true
    ...
    var body: some View {
        ...
        NavigationStack {
            ZStack {
                ...
                if isEventView {
                    EventView(isDarkMode: isDarkMode)
                } else {
                    // Main view
                                    ...
                                    TabView {
                                        ...
                                        ForEach(Place.topPlaces.indices, id: \.self) {
                                            ...
                                            GeometryReader {
                                                ...
                                                {
                                                    PlaceCardView(isDarkMode: $isDarkMode, place: Place.topPlaces[index])
                                                        .padding(.horizontal)
                                        ...
                                        if searchInput != "" {
                                            ...
                                            }).count == 0
                                            {
                                                    ...
                                                    , id: \.self)
                                                {
                                                    ...
                                                    {
                                                        SmallPlaceCardView(isDarkMode: $isDarkMode, place: Place.allPlace[index])
                                                    }
                                                    .simultaneousGesture(
                                                        TapGesture()
                                                            .onEnded {
